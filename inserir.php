...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $matricula = $conn -> real_escape_string($_POST['nome']);
    $funcao = $conn -> real_escape_string($_POST['nome']);

    //Inserir no banco
    $sql = "INSERT INTO usuarios (ID, nome, matricula, funcao) VALUES('$nome', '$matricula', '$funcao')";
    if($conn -> query($sql)){
